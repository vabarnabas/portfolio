...
const Projects = () => {
    ...
    const projects = [
        ...
        },
        {
            ...
            description: '',
            image: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1472&q=80',
            url: 'https://poke.barnabee.studio',
            sourceUrl: 'https://github.com/vabarnabas/pokeapi',
                ...
                {projects.map((item) => (
                    <div key={item.name} className="bg-slate-100 ring-1 ring-slate-300 rounded-lg overflow-hidden text-slate-600 pb-4 h-max">
                        <div className="relative">
                            <div className="absolute group inset-0 bg-indigo-500 bg-opacity-[0.8] flex items-center justify-center cursor-pointer">
                                <HiSearch className='absolute right-2 bottom-2 text-white text-xl group-hover:block hidden' />
                            </div>
